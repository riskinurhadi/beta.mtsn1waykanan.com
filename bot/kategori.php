...
$query_berita = "SELECT * FROM berita WHERE kategori = ? ORDER BY tanggal_publikasi DESC LIMIT ? OFFSET ?";
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            <h1 class="page-title mt-5"><?php echo htmlspecialchars($nama_kategori); ?></h1>
            <p class="page-subtitle mb-2">Menampilkan Berita Kategori</p>
    ...
    <!-- ============================================= -->
    <!-- BAGIAN SCRIPT (TELAH DIPERBAIKI) -->
    <!-- ============================================= -->
