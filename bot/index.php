...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="">Profil Madrasah</a></li>
                            ...
                            <li><a class="dropdown-item" href="sejarah.html">Struktur Madrasah</a></li>
                            <li><a class="dropdown-item" href="sejarah.html">Profil Guru</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="">Tata Tertib Madrasah</a></li>
    ...
    <div class="alert alert-dev-progress alert-dismissible fade show" role="alert">
        <div class="container text-center">
            <strong>Update Progres Development (4 Juli 2025):</strong> Penambahan Logo pada Navbar, Pembuatan Halaman Admin, termasuk didalamnya Pengelolaan Berita, Prestasi, Galeri, dan lain lain.
    ...
    <section class="visi-misi-section">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="visi-misi-tujuan.html" class="btn btn-outline-success btn-lg">Baca Selengkapnya</a>
            </div>
        </div>
    </section>
...
<div class="row g-4">
    ...
    ?>
            <!-- Kartu Prestasi (Template Dinamis) -->
            <div class="col-lg-4 col-md-6">
                <div class="prestasi-card">
                    ...
                    <div class="prestasi-content">
                        ...
                        <!-- Menampilkan deskripsi yang sudah dipotong dengan aman -->
                        <p class="prestasi-deskripsi" style="font-size: 14px; color: #666; margin-bottom: 15px;"><?php echo htmlspecialchars($deskripsi_tampil); ?></p>
    ...
    <section class="alumni-section">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <!-- CATATAN: Blok ini nantinya bisa di-generate dari database -->
                ...
                <div class="col-lg-10">
                    <div class="alumni-card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <!-- Ganti dengan foto alumni -->
                                <img src="https://i.pinimg.com/736x/42/47/3e/42473ebf3441c680fa2b82d31cb81e6f.jpg" class="alumni-img" alt="Foto Alumni 1">
                            </div>
                            <div class="col-md-8">
                                <div class="alumni-content">
                                    <h4 class="alumni-name">Dr. H. Muhammad Fauzan, M.Si.</h4>
                                    <p class="alumni-year">Lulusan Tahun 2005 - Dosen & Peneliti</p>
                                    <p class="alumni-quote">"Pendidikan karakter dan agama yang saya dapatkan di MTsN 1 Way Kanan menjadi fondasi utama kesuksesan saya saat ini. Saya sangat berterima kasih kepada para guru."</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-10">
                    <div class="alumni-card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <!-- Ganti dengan foto alumni -->
                                <img src="https://images.unsplash.com/photo-1556157382-97eda2d62296?q=80&w=2070&auto=format&fit=crop" class="alumni-img" alt="Foto Alumni 2">
                            </div>
                            <div class="col-md-8">
                                <div class="alumni-content">
                                    <h4 class="alumni-name">Aisyah Putri, S.Kom.</h4>
                                    <p class="alumni-year">Lulusan Tahun 2010 - Software Engineer</p>
                                    <p class="alumni-quote">"Selain ilmu akademik, madrasah ini mengajarkan saya tentang kerja keras, disiplin, dan pentingnya komunitas. Bekal yang sangat berharga di dunia kerja."</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 mx-auto text-center">
                    ...
                    <a href="#" class="btn btn-light btn-lg cta-button">Daftar Sekarang</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="contact-info-grid">
            <div class="info-card">
                ...
                <h4>Alamat Kami</h4>
                <p>Jl. Lintas Sumatera, Gistang, Blambangan Umpu, Kab. Way Kanan, Lampung.</p>
            </div>
    ...
    <section>
        ...
        <div class="footer-container">
            <div class="footer-column footer-about">
                ...
                <p>
                    <i class="fas fa-map-marker-alt"></i>
                    Jl. Lintas Sumatera, Gistang, Blambangan Umpu, Kab. Way Kanan, Lampung.
                </p>
                <p>
                    <i class="fas fa-envelope"></i>
        ...
        <div class="footer-bottom">
            <p>Â© 2025 MTs Negeri 1 Way Kanan. Semua Hak Cipta Dilindungi.</p>
        </div>
    </footer>
    </section>
