            ...
            <div class="table-container">
                <table class="data-table" id="prestasiTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="uploads/prestasi/<?php echo htmlspecialchars($prestasi['foto_url'] ?? 'default-prestasi.png'); ?>" alt="Foto Prestasi" class="prestasi-thumb" loading="lazy"></td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="edit_prestasi.php?id=<?php echo $prestasi['id']; ?>" class="btn-action btn-edit" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                    <button type="button" class="btn-action btn-delete" onclick="confirmDelete(<?php echo $prestasi['id']; ?>)" title="Hapus"><i class="fas fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#prestasiTable').DataTable({
                ...
                order: [[4, 'desc']], // Default urutkan berdasarkan Tahun (kolom ke-4), descending
                columnDefs: [
                    ...
                    { searchable: true, targets: [1, 2, 3, 4] }, // Kolom Nama Siswa, Nama Prestasi, Tingkat, dan Tahun bisa dicari
                    { orderable: true, targets: [1, 2, 3, 4] } // Kolom Nama Siswa, Nama Prestasi, Tingkat, dan Tahun bisa diurutkan
                ],
                responsive: true,
                processing: true,
