...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Ambil semua data dari form sesuai struktur baru
    $id = $_POST['id'];
    ...
    // Validasi input
    if (empty($nama) || empty($guru_mapel)) {
        $errors[] = "Nama dan Guru Mapel tidak boleh kosong.";
    }
    ...
    if (empty($errors)) {
        ...
        $sql = "UPDATE data_guru SET nama = ?, guru_mapel = ?, nip = ?, pangkat_golongan = ?, jabatan = ?, alamat = ?, no_hp = ?, foto_guru = ? WHERE id = ?";
        if ($stmt = $conn->prepare($sql)) {
            // PERUBAHAN: bind_param disesuaikan
            $stmt->bind_param("ssssssssi", $nama, $guru_mapel, $nip, $pangkat_golongan, $jabatan, $alamat, $no_hp, $new_file_name, $id);
            if ($stmt->execute()) {
...
$sql_select = "SELECT * FROM data_guru WHERE id = ?";
    ...
    <main class="main-content">
        ...
        <section class="content">
            <div class="form-card">
                ...
                <form action="edit_guru.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <input type="hidden" name="current_foto" value="<?php echo htmlspecialchars($guru['foto_guru']); ?>">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="guru_mapel" name="guru_mapel" value="<?php echo htmlspecialchars($guru['guru_mapel']); ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="nip">NIP</label>
                            <input type="text" id="nip" name="nip" value="<?php echo htmlspecialchars($guru['nip']); ?>">
                        </div>
                        <div class="form-group">
                            <label for="pangkat_golongan">Pangkat/Golongan</label>
                            <input type="text" id="pangkat_golongan" name="pangkat_golongan" value="<?php echo htmlspecialchars($guru['pangkat_golongan']); ?>">
                        </div>
                        <div class="form-group">
                            <label for="jabatan">Jabatan</label>
                            <input type="text" id="jabatan" name="jabatan" value="<?php echo htmlspecialchars($guru['jabatan']); ?>">
                        </div>
                        <div class="form-group">
                            <label for="no_hp">No. HP</label>
                            <input type="text" id="no_hp" name="no_hp" value="<?php echo htmlspecialchars($guru['no_hp']); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img src="uploads/guru/<?php echo htmlspecialchars($guru['foto_guru'] ?? 'default-profile.png'); ?>" alt="Foto saat ini" class="current-image">
                    </div>
                    <div class="form-group">
                        <label for="foto_guru">Ganti Foto (Opsional)</label>
