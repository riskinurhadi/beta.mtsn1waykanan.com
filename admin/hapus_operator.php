...
// 2. PERUBAHAN: Cek apakah rolenya adalah 'superadmin' atau 'developer'
if (!in_array($_SESSION['role'], ['superadmin', 'developer'])) {
    // Jika bukan, tampilkan halaman akses ditolak yang sudah didesain
...
<body>
    <div class="access-denied-container">
        ...
        <h1>Akses Ditolak</h1>
        <p>Anda tidak memiliki izin untuk menghapus akun operator.</p>
...
if (isset($_GET['id']) && filter_var($_GET['id'], FILTER_VALIDATE_INT)) {
    ...
    // 4. Mencegah pengguna menghapus akunnya sendiri
        ...
        if ($stmt_delete = $conn->prepare($sql_delete)) {
            ...
            if ($stmt_delete->execute()) {
                ...
                if ($file_to_delete && $file_to_delete !== 'default.png') {
                    // PERBAIKAN: Path ke folder upload diperbaiki
