...
// BERITA
// Fungsi untuk membuat ringkasan/excerpt dari isi berita
function buat_ringkasan($konten, $panjang = 120) {
    // Menghapus tag HTML dari konten editor
...
// Query untuk mengambil 4 data pejabat pertama, diurutkan berdasarkan kolom 'urutan'
                        ...
                        <div class="dropdown-menu dropdown-megamenu" aria-labelledby="pemerintahDropdown">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <a class="dropdown-item" href="#">Aparatur Desa</a>
                        ...
                        <div class="dropdown-menu dropdown-megamenu" aria-labelledby="daerahDropdown">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <a class="dropdown-item" href="#">Letak dan Luas Wilayah</a>
                                    <a class="dropdown-item" href="#">Karakteristik Wilayah</a>
                                    <a class="dropdown-item" href="#">Topografi</a>
                                </div>
                                <div class="col-lg-6">
...
<section id="visimisi" class="py-5" style="background-color: #f8f9fa;">
    <div class="container">
            ...
            <div class="col-lg-6">
                <div class="vm-card">
                    ...
                    <div class="vm-content">
                        <h3>Visi</h3>
                        <p>
                            "Terwujudnya Desa Tampingan yang Maju, Mandiri, Sejahtera, dan Berbudaya Berlandaskan Iman dan Taqwa."
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="vm-card">
                    ...
                    <div class="vm-content">
                        <h3>Misi</h3>
                        <ul>
                            <li>Meningkatkan kualitas sumber daya manusia yang cerdas dan kompetitif.</li>
                            <li>Mengoptimalkan penyelenggaraan pemerintahan desa yang transparan dan akuntabel.</li>
                            ...
                            <li>Menciptakan lingkungan yang aman, tertib, dan harmonis.</li>
                        </ul>
                    </div>
                </div>
            </div>
