...
<head>
   <meta charset="UTF-8">
    ...
    <title>MTs Negeri 1 Way Kanan - MTs Negeri Pertama di Way Kanan</title>
...
/* =============================================
    Mengembalikan gaya teks di dalam kartu
   ============================================= */
...
.whatsapp-button {
  position: fixed; /* Membuat posisi ikon tetap saat di-scroll */
  ...
  border-radius: 50%; /* Membuat bentuknya menjadi lingkaran */
  text-align: center; /* Posisi ikon di tengah secara horizontal */
  font-size: 30px; /* Ukuran ikon di dalam lingkaran */
  line-height: 60px; /* Posisi ikon di tengah secara vertikal */
  box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.25); /* Efek bayangan */
  z-index: 1000; /* Memastikan ikon selalu di atas konten lain */
  transition: all 0.3s ease-in-out; /* Efek transisi halus */
}

/* Efek saat kursor mouse di atas ikon */
.whatsapp-button:hover {
  background-color: #128C7E; /* Warna hijau lebih gelap */
  transform: scale(1.1); /* Sedikit memperbesar ikon */
  color: #FFFFFF; /* Memastikan warna ikon tetap putih */
}
...
.slider-container {
            /* Menghapus border-radius dan box-shadow agar menyatu dengan tepi layar */
            border-radius: 0;
            box-shadow: none;
        }
        ...
        /* Media query untuk membuat slider responsif di layar kecil */
        @media (max-width: 768px) {
            .carousel-item img {
                height: 150px; /* Tinggi banner lebih kecil untuk perangkat mobile */
            }
        }
    </style>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="https://mtsn1waykanan.com/kontributor">Kontributor</a></li>
                            <!--<li><a class="dropdown-item" href="https://asndigital.bkn.go.id/">ASN</a></li>-->
                            <!--<li><a class="dropdown-item" href="">PTSP</a></li>-->
                            <!--<li><a class="dropdown-item" href="sejarah.html">PTSP</a></li>-->
                            <!--<li><a class="dropdown-item" href="sejarah.html">Legalisir Online</a></li>-->
                    ...
                    <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
                        ...
                        <a class="btn btn-ppdb" href="https://mtsn1waykanan.com/kontributor">Kontributor</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-md-7">
                    ...
                    <a href="https://mtsn1waykanan.com/ppdb/" class="btn btn-success btn-lg hero-button">Penerimaan Siswa Baru</a>
                </div>
            </div>
        </div>
    </header>
...
<!--WhatsApp-->
<section>
  <a href="https://wa.me/6285266456130?text=Halo%20Admin,%20Saya%20mau%20bertanya%20mengenai%20MTs%20Negeri%201%20Way%20Kanan" class="whatsapp-button" target="_blank" aria-label="Hubungi kami via WhatsApp">
...
<!--end WhatsApp-->
    ...
    <!--        <strong>Update Progres Development (18 Juli 2025):</strong> Penyempurnaan Website, dan penambahan fitur share by QR pada halaman detail berita, Progres pengerjaan per tanggal 16 Juli 2025 mencapai 95%.-->
    ...
    <!--        <div class="col-lg-10 col-md-12">-->
                ...
                <!-- 'data-bs-ride="carousel"' akan memulai slider secara otomatis -->
                <!--<div id="ppdbBannerSlider" class="carousel slide slider-container" data-bs-ride="carousel">-->
                    <!-- Indikator slide (titik-titik di bawah) -->
                <!--    <div class="carousel-indicators">-->
                <!--        <button type="button" data-bs-target="#ppdbBannerSlider" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>-->
                <!--        <button type="button" data-bs-target="#ppdbBannerSlider" data-bs-slide-to="1" aria-label="Slide 2"></button>-->
                <!--        <button type="button" data-bs-target="#ppdbBannerSlider" data-bs-slide-to="2" aria-label="Slide 3"></button>-->
                <!--    </div>-->

                    <!-- Konten gambar slider -->
                <!--    <div class="carousel-inner">-->
                        <!-- Slide 1 -->
                        <!-- 'data-bs-interval="5000"' mengatur durasi slide ini menjadi 5 detik -->
                <!--        <div class="carousel-item active" data-bs-interval="4000">-->
                            <!-- Ganti 'src' dengan path gambar Anda, misal: 'assets/banner1.jpg' -->
                <!--            <img src="admin/uploads/banner/4.png" class="d-block w-100" alt="Banner PPDB 1" onerror="this.onerror=null;this.src='https://placehold.co/1200x450/28a745/FFFFFF?text=Banner+PPDB+1';">-->
                <!--        </div>-->
                        <!-- Slide 2 -->
                <!--        <div class="carousel-item" data-bs-interval="5000">-->
                <!--            <img src="admin/uploads/banner/3.png" class="d-block w-100" alt="Banner PPDB 2" onerror="this.onerror=null;this.src='https://placehold.co/1200x450/006400/FFFFFF?text=Banner+PPDB+2';">-->
                <!--        </div>-->
                        <!-- Slide 3 -->
                        <!--<div class="carousel-item" data-bs-interval="5000">-->
                        <!--    <img src="admin/uploads/banner/banner3.png" class="d-block w-100" alt="Banner PPDB 3" onerror="this.onerror=null;this.src='https://placehold.co/1200x450/1e8449/FFFFFF?text=Banner+PPDB+3';">-->
                        <!--</div>-->
                <!--    </div>-->

                    <!-- Tombol navigasi Kiri & Kanan -->
                <!--    <button class="carousel-control-prev" type="button" data-bs-target="#ppdbBannerSlider" data-bs-slide="prev">-->
                <!--        <span class="carousel-control-prev-icon" aria-hidden="true"></span>-->
                <!--        <span class="visually-hidden">Previous</span>-->
                <!--    </button>-->
                <!--    <button class="carousel-control-next" type="button" data-bs-target="#ppdbBannerSlider" data-bs-slide="next">-->
                <!--        <span class="carousel-control-next-icon" aria-hidden="true"></span>-->
                <!--        <span class="visually-hidden">Next</span>-->
                <!--    </button>-->
                <!--</div>-->
                <!-- AKHIR SECTION BANNER SLIDER -->
...
<div class="row g-4">
    <?php
    //  Atur header HTTP untuk memaksa UTF-8
    ...
    ?>
            <!--  Kartu sekarang dibungkus dengan tag <a> -->
    ...
    <section class="alumni-section">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                ...
                include 'koneksi.php';
                //  Mengembalikan query ke kondisi normal.
    ...
    <section id="berita" class="news-section">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                // Query Baru
                $query_berita = "SELECT * FROM berita WHERE status_berita = 'Diterbitkan' ORDER BY tanggal_publikasi DESC LIMIT 3";
    ...
    <div class="container">
        ...
        <div class="contact-info-grid">
            ...
            <div class="info-card">
                ...
                <h4>Nomor Kontak</h4>
                <p>Telepon: (+62) 852 6645 6130<br>Email: mtsn1waykanan@gmail.com</p>
            </div>
        ...
        <!--  Form sekarang memiliki method dan action -->
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="contact-form">
            <div class="form-grid">
                <!--  Atribut 'name' disesuaikan dengan kolom database -->
