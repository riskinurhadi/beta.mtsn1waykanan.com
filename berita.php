...
$query_berita = "SELECT * FROM berita WHERE status_berita = 'Diterbitkan' ORDER BY tanggal_publikasi DESC LIMIT ? OFFSET ?";
...
.main-footer {
    ...
    <header class="page-header">
        <div class="container mt-5">
            <h1 class="page-title">Arsip Berita</h1>
            <p class="page-subtitle">Kumpulan Informasi, Kegiatan, dan Pengumuman Madrasah</p>
        </div>
    </header>
    ...
    <footer class="main-footer">
        <p class="mb-0">
            ...
            Versi 1.0 | Develop by : <a href="https://risky.kemusukkidul.com/" target="_blank" rel="noopener noreferrer">Riskyy</a>
        </p>
    </footer>
